...
def download():
		...
		if '' in quality:
			pass
		if '240' in quality:
			r=os.system('youtube-dl -f 133 '+ytplaylink)
		if '360' in quality:
			r=os.system('youtube-dl -f 134 '+ytplaylink)
		elif '480' in quality:
			r=os.system('youtube-dl -f 135 '+ytplaylink)
		elif '720' in quality:
			r=os.system('youtube-dl -f 136 '+ytplaylink)
		if(r==1):
