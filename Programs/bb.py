...
def assistant(command):
    ...
    if command == "hello1" or command == "hi1" or command=="hey1":
        ...
        if 'website' in command:
        	...
        	os.system('start "" "D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\Notes.txt"')
        ...
        if "download" in command:
            ...
            def download():
                ...
                if '' in quality:
                    pass
                if '240' in quality:
                    r=os.system('"cd D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\video" && youtube-dl -f 5 '+ytplaylink1)
                if '360' in quality:
                    r=os.system('"cd D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\video" && youtube-dl -f 43 '+ytplaylink1)
                elif '480' in quality:
                    r=os.system('"cd D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\video" && youtube-dl -f 18 '+ytplaylink1)
                elif '720' in quality:
                    r=os.system('"cd D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\video" && youtube-dl -f 22 '+ytplaylink1)
                if(r==1):
    ...
    elif 'quotes' in command or 'quote' in command:
        ...
        command=command.replace('Play',"")
        for root, dirs,files in os.walk("D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\music"):
            for file in files:
                file = file.replace('(',"")
                file = file.replace(')',"")
                # file = file.replace(''," ") 
                ...
                if command in file.replace('_',' '):
                    path = "D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\music"+'\\'+file
                    os.system('"'+path+'"')
                    break
            else:
                ...
                if(typeCommand()=='yes'):
                    ...
                    word2 = '1_'+word2
                    os.system('"cd D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\music" && youtube-dl --output '+word2+'.%(ext)s -i --extract-audio --audio-format mp3 --audio-quality 0 '+ytplaylink2)
                    #webbrowser.open_new_tab(ytplaylink)
                else:
                    talkToMe("Ok, ask me something else.")

    elif 'music' in command or 'song' in command or 'play' in command:
        a=str(random.choice(os.listdir("D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\music")))
        path = "D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\music"+'\\'+a
        os.system(path)

    

        # if 'video' in command:
        #     a=str(random.choice(os.listdir("D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\videos")))
        #     path = "D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\videos"+'\\'+a
        #     os.system(path)
        ...
        a=str(random.choice(os.listdir("D:\ZZZ\SRKsongs")))
        path = "D:\\ZZZ\\SRKsongs"+'\\'+a
        os.system(path)
        ...
        a=str(random.choice(os.listdir("D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\images")))
        print('a',a)
        pic_path = "D:\\ArmanK\\python_programs\\SUBLIME_FILES\\SpeechRecog\\images"+'\\'+a
