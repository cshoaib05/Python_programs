...
def assistant(command):
    ...
    if command == "hello1" or command == "hi1" or command=="hey1":
        ...
        elif 'increase' in command or 'up' in command or 'more' in command:
            os.system('nircmd.exe changesysvolume 10000')
        elif 'decrease' in command or 'down' in command or 'low' in command:
            os.system('nircmd.exe changesysvolume -10000')
